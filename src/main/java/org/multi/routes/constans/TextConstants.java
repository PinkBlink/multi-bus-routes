...
public class TextConstants {
    ...
    public static final String MAX_BUSSES_CAPACITY_STRING = " max_busses: ";
    ...
    public static final String BUS_STOP_REGEX = "^" + BUS_STOP_STRING + "[\\w]+" + MAX_BUSSES_CAPACITY_STRING + "[0-9]+$";
}
