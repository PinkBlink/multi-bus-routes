...
public class App {
    ...
    public static void main(String[] args) {
        ...
        bus1.setDestination(stop3);
        bus2.setDestination(stop3);

        try {
            Future<String> busString1 = executorService.submit(bus1);
            Future<String> busString2 = executorService.submit(bus2);
            Future<String> busString3 = executorService.submit(bus3);
