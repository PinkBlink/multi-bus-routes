...
public class TextConstants {
    ...
    public static final String PASSENGER_REGEX = "^" + PASSENGER_NAME_STRING + "[a-zA-Z]{3,} [a-zA-Z]{3,}"
            + PASSENGER_CURRENT_STOP_STRING + "[\\w]+"
            + PASSENGER_DESTINATION_STRING + "[\\w]+$";
    public static final String BUS_REGEX = "^" + BUS_NUMBER_STRING + "[0-9]+"
    ...
    public static final String BUS_ROUTE_REGEX = "^" + BUS_ROUTE_NUMBER_STRING
